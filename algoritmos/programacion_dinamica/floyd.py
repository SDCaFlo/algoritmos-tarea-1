            ...
            for piv_node_row in pivoted_nodes:
                for piv_node_col in pivoted_nodes:
                    ...
                    if candidate_cost < curr_value:
                        self.set_matrix_element(candidate_cost, piv_node_row, piv_node_col, 'cost')
                        self.set_matrix_element(pivot, piv_node_row, piv_node_col, 'route')
